...
export const MARKET_ASSETS: Asset[] = [
    ...
    { id: '31', ticker: 'SUI', name: 'Sui', price: 28.50, volume24h: 380000000, change24h: 7.2 },
    { id: '32', ticker: 'SEI', name: 'Sei', price: 4.20, volume24h: 220000000, change24h: -2.5 },
    { id: '33', ticker: 'WIF', name: 'dogwifhat', price: 3.80, volume24h: 450000000, change24h: 18.5 },
    { id: '34', ticker: 'BONK', name: 'Bonk', price: 0.000035, volume24h: 280000000, change24h: 12.1 },
    { id: '35', ticker: 'FLOKI', name: 'Floki', price: 0.00028, volume24h: 95000000, change24h: 6.8 },
    { id: '36', ticker: 'STX', name: 'Stacks', price: 2.45, volume24h: 120000000, change24h: -1.2 },
    { id: '37', ticker: 'TIA', name: 'Celestia', price: 12.80, volume24h: 180000000, change24h: 4.3 },
    { id: '38', ticker: 'IMX', name: 'Immutable X', price: 1.95, volume24h: 65000000, change24h: -0.9 },
    { id: '39', ticker: 'FET', name: 'Fetch.ai', price: 2.10, volume24h: 88000000, change24h: 3.1 },
    { id: '40', ticker: 'RUNE', name: 'THORChain', price: 8.50, volume24h: 72000000, change24h: -2.2 },
    { id: '41', ticker: 'AAVE', name: 'Aave', price: 420, volume24h: 95000000, change24h: 1.5 },
    { id: '42', ticker: 'MKR', name: 'Maker', price: 1850, volume24h: 48000000, change24h: -0.4 },
    { id: '43', ticker: 'CRV', name: 'Curve DAO', price: 8.20, volume24h: 52000000, change24h: 2.8 },
    { id: '44', ticker: 'UNI', name: 'Uniswap', price: 18.50, volume24h: 140000000, change24h: -1.1 },
    { id: '45', ticker: 'SAND', name: 'The Sandbox', price: 0.85, volume24h: 38000000, change24h: 0.6 },
    { id: '46', ticker: 'MANA', name: 'Decentraland', price: 0.72, volume24h: 42000000, change24h: -1.8 },
    { id: '47', ticker: 'AXS', name: 'Axie Infinity', price: 12.40, volume24h: 55000000, change24h: 2.4 },
    { id: '48', ticker: 'EGLD', name: 'MultiversX', price: 85, volume24h: 32000000, change24h: -0.7 },
    { id: '49', ticker: 'FTM', name: 'Fantom', price: 1.25, volume24h: 68000000, change24h: 5.2 },
    { id: '50', ticker: 'ALGO', name: 'Algorand', price: 0.45, volume24h: 29000000, change24h: 0.3 },
];
